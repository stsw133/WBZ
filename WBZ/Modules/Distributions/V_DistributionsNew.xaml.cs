...
namespace WBZ.Modules.Distributions
{
    ...
    public partial class DistributionsNew : New
    {
        ...
        public DistributionsNew(MODULE_MODEL instance, Commands.Type mode)
        {
            ...
            if (mode == Commands.Type.EDIT && D.InstanceData.Status != (int)MS_Distributions.Statuses[0].Value)
            ...
            if (window.ShowDialog() == true)
            {
                ...
                if (family == null)
                {
                    family = new M_DistributionFamily()
                    {
                        ...
                        FamilyName = window.Selected.Name,
            ...
            do
            {
                ...
                if (window2.ShowDialog() == true)
                {
                    if (window2.Selected != null)
                    {
                        ...
                        row["store"] = window2.CmbBoxStoresList.SelectedValue;
                        row["storename"] = window2.CmbBoxStoresList.Text;
